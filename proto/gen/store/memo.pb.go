...
func (x *MemoPayload) GetLinks() []*MemoPayload_LinkMetadata {
	if x != nil {
		return x.Links
	}
	return nil
...
type MemoPayload_LinkMetadata struct {
	state       protoimpl.MessageState `protogen:"open.v1"`
...
func (x *MemoPayload_LinkMetadata) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
// Deprecated: Use MemoPayload_LinkMetadata.ProtoReflect.Descriptor instead.
func (*MemoPayload_LinkMetadata) Descriptor() ([]byte, []int) {
	return file_store_memo_proto_rawDescGZIP(), []int{0, 2}
}

func (x *MemoPayload_LinkMetadata) GetUrl() string {
	if x != nil {
		return x.Url
	}
	return ""
...
func (x *MemoPayload_LinkMetadata) GetTitle() string {
	if x != nil {
		return x.Title
	}
	return ""
...
func (x *MemoPayload_LinkMetadata) GetDescription() string {
	if x != nil {
...
func (x *MemoPayload_LinkMetadata) GetImage() string {
	if x != nil {
		return x.Image
	}
	return ""
...
func (x *MemoPayload_LinkMetadata) GetCoverAttachmentUid() string {
	if x != nil {
